            ...
            <div className="col-lg-6">
              <div className="signup-left">
                <h4 className="text-capitalize">
                  Please register with our services if you are not already a registered user.
                </h4>
              </div>
            </div>
            <div className="col-lg-6">
                ...
                <form noValidate onSubmit={this.registerSubmit}>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-12">
                      ...
                      <select type="role" className="input-control" placeholder="Enter your role" id="role" value={role} onChange={this.onChangeRegister} error={errors.role} className={classnames('', { invalid: errors.role })}>
